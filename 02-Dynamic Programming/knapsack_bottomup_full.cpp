...
pair<int,string> knapsack(int V[], int S[], int n, int C){
    int K[n+1][C+1];
    string R[n+1][C+1];
...
int main(int argc, char** argv){
    ...
    pair<int,string> results = knapsack(V, S, n, C);
    cout << "El valor máximo obtenible es: $" << results.first << "\n";
    cout << "Se obtiene al seleccionar los items: " << results.second << "\n";
